      ...
      >
        ...
        <SubMenu label={dictionary['navigation'].pages} icon={<i className='ri-file-list-2-line' />}>
          ...
          <SubMenu label={dictionary['navigation'].miscellaneous} icon={<i className='ri-file-info-line' />}>
            <MenuItem href={`/${locale}/pages/misc/coming-soon`} target='_blank' rel="noopener noreferrer">
              {dictionary['navigation'].comingSoon}
            </MenuItem>
            <MenuItem href={`/${locale}/pages/misc/under-maintenance`} target='_blank' rel="noopener noreferrer">
              {dictionary['navigation'].underMaintenance}
            </MenuItem>
            <MenuItem href={`/${locale}/pages/misc/404-not-found`} target='_blank' rel="noopener noreferrer">
              {dictionary['navigation'].pageNotFound404}
            </MenuItem>
            <MenuItem href={`/${locale}/pages/misc/401-not-authorized`} target='_blank' rel="noopener noreferrer">
          ...
          <SubMenu label={dictionary['navigation'].authPages} icon={<i className='ri-shield-keyhole-line' />}>
            <SubMenu label={dictionary['navigation'].login}>
              <MenuItem href={`/${locale}/pages/auth/login-v1`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].loginV1}
              </MenuItem>
              <MenuItem href={`/${locale}/pages/auth/login-v2`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].loginV2}
              </MenuItem>
            </SubMenu>
            <SubMenu label={dictionary['navigation'].register}>
              <MenuItem href={`/${locale}/pages/auth/register-v1`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].registerV1}
              </MenuItem>
              <MenuItem href={`/${locale}/pages/auth/register-v2`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].registerV2}
              </MenuItem>
              <MenuItem href={`/${locale}/pages/auth/register-multi-steps`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].registerMultiSteps}
              </MenuItem>
            </SubMenu>
            <SubMenu label={dictionary['navigation'].verifyEmail}>
              <MenuItem href={`/${locale}/pages/auth/verify-email-v1`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].verifyEmailV1}
              </MenuItem>
              <MenuItem href={`/${locale}/pages/auth/verify-email-v2`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].verifyEmailV2}
              </MenuItem>
            </SubMenu>
            <SubMenu label={dictionary['navigation'].forgotPassword}>
              <MenuItem href={`/${locale}/pages/auth/forgot-password-v1`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].forgotPasswordV1}
              </MenuItem>
              <MenuItem href={`/${locale}/pages/auth/forgot-password-v2`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].forgotPasswordV2}
              </MenuItem>
            </SubMenu>
            <SubMenu label={dictionary['navigation'].resetPassword}>
              <MenuItem href={`/${locale}/pages/auth/reset-password-v1`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].resetPasswordV1}
              </MenuItem>
              <MenuItem href={`/${locale}/pages/auth/reset-password-v2`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].resetPasswordV2}
              </MenuItem>
            </SubMenu>
            <SubMenu label={dictionary['navigation'].twoSteps}>
              <MenuItem href={`/${locale}/pages/auth/two-steps-v1`} target='_blank' rel="noopener noreferrer">
                {dictionary['navigation'].twoStepsV1}
              </MenuItem>
              <MenuItem href={`/${locale}/pages/auth/two-steps-v2`} target='_blank' rel="noopener noreferrer">
          ...
          <SubMenu label={dictionary['navigation'].frontPages} icon={<i className='ri-file-copy-line' />}>
            <MenuItem href={`/${locale}/`} target='_blank' rel="noopener noreferrer">
              {dictionary['navigation'].landing}
            </MenuItem>
            <MenuItem href={`/${locale}/pricing`} target='_blank' rel="noopener noreferrer">
              {dictionary['navigation'].pricing}
            </MenuItem>
            <MenuItem href={`/${locale}/payment`} target='_blank' rel="noopener noreferrer">
              {dictionary['navigation'].payment}
            </MenuItem>
            <MenuItem href={`/${locale}/checkout`} target='_blank' rel="noopener noreferrer">
              {dictionary['navigation'].checkout}
            </MenuItem>
            <MenuItem href={`/${locale}/help-center`} target='_blank' rel="noopener noreferrer">
