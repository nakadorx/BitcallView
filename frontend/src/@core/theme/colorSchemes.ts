  ...
  return {
    light: {
      palette: {
        ...
        secondary: {
          ...
          darkOpacity: 'rgb(var(--mui-palette-secondary-mainChannel) / 1.32)',
          darkerOpacity: 'rgb(var(--mui-palette-secondary-mainChannel) / 1.38)'
        },
        error: {
          main: '#FF4D49',
          light: '#FF716D',
    ...
    dark: {
      palette: {
        ...
        background: {
          default: skin === 'bordered' ? '#151a28' : '#151a28',
          paper: '#151a28',
